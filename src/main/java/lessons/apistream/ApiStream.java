...
public class ApiStream {
    ...
    public static void main(String[] args) {
        ...
        employeesTics.add(new Employee("Jhon Doe", 22, 2500.00, "Web Developer"));
        employeesTics.add(new Employee("James Gosling", 52, 4500.00, "Software Enginer"));
        employeesTics.add(new Employee("Taylor Otwell", 42, 3000.00, "Web Developer"));
        employeesTics.add(new Employee("Miguel Angel Duran", 32, 3000.00, "Scrum Master"));
        employeesTics.add(new Employee("Sara Nicholl", 22, 3000.00, "Frontend Developer"));

        double totalSalaryTics = employeesTics.stream().mapToDouble(employee -> employee.getSalary()).sum();
        ...
        employeesAdministration.add(new Employee("Wild Smith", 45, 4000.00, "General manager"));
        employeesAdministration.add(new Employee("Elon Musk", 50, 3500.00, "Lawyer"));
        employeesAdministration.add(new Employee("Andrew Garfield", 35, 3500.00, "Treasurer"));
        employeesAdministration.add(new Employee("Amanda Hans", 25, 2500.00, "Secretary"));

        double totalSalaryAdmin = employeesAdministration.stream().mapToDouble(employee -> employee.getSalary()).sum();
    ...
    public static void introStream() {
        ...
        Stream<Integer> streamGenerate = Stream.generate(() -> (new Random()).nextInt(20)).limit(5);
        streamGenerate.forEach(System.out::println);
        Stream<String> streamIterate = Stream.iterate("abc", (i) -> i + "dfgh").limit(5);
        ...
        Stream<String> streamSortedString = Stream.of("JavaScript", "PHP", "Go", "Ruby", "C#");
        streamSortedString.sorted(Comparator.reverseOrder())
        ...
        Stream<String> streamForEach = Stream.of("English", "Spanish", "French", "German", "Italian");
        ...
        Stream<String> streamCollect = Stream.of("English", "Spanish", "French", "German", "Italian");
        ...
        // Predicate (predicado).
        String[] arrayString = new String[] { "English", "Spanish", "French", "German", "Italian" };
        Predicate<String> predicate = value -> value.contains("i");
        System.out.println("* Stream { anyMatch(), allMatch(), noneMatch() } :");
        ...
        long totalMatched = Arrays.stream(arrayString).filter(value -> value.startsWith("E")).count();
